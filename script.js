...
const projects = [
...

  {
    ...
    description2:
      '"Micro Biz Finder" The application was created with React and Redux, using the Yelp fuction API. Develop the application for a geolocated micro directory, where tourists and residents can easily search for services and entertainment in the city of Montreal, QC, Canada. The application is designed so that you can easily create local directories for other cities.',
    image: 'images/p3.png',
    html: 'HTML',
    css: 'CSS',
    javascript: 'JavaScript',
  ...
  },
  {
    ...
    description2:
      '"Star Wars Movies" The JavaScript capstone project is about building your own web application based on an external API. You will select an API that provides data about a topic that you like and then build the webapp around it. The webapp will have 2 user interfaces: A home page showing a list of items that you can "like." A popup window with more data about an item',
    image: 'images/p4.png',
    html: 'HTML',
    css: 'CSS',
    javascript: 'JavaScript',
